...
window.oxo = {
  ...
  elements: {
     ...
     */
    onLeaveScreen: function onLeaveScreen(element, action, once) {
     ...
     * @return {IntersectionObserver} - The observer
     */
    onLeaveScreenOnce: function onLeaveScreenOnce(element, action) {
     ...
     */
    elementsAreColliding: function elementsAreColliding(element1, element2) {
